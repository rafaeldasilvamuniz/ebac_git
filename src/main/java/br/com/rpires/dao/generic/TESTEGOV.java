...
public class ExemploIntegracaoGovBr {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\n\nDados do usuário:");
        System.out.println("CPF: " + idTokenJwtClaims.getSubject()); // CPF da(o) usuária(o) autenticado.
        System.out.println("RG: " + idTokenJwtClaims.getSubject()); // RG do(A) usuário(A) autenticado.
        ...
        System.out.println("Observacao: " + observacao); // Alguma observação da(o) usuária(o) no Gov.br.
        // email foi
        // validado no
        // cadastro do
        // Gov.br. Poderá
