 ...
 * 
 */
package br.com.rmuniz.vendas.online.exception;
...
import br.com.rmuniz.vendas.online.errorhandling.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        String error = ex.getParameterName() + " parametro enviado";
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        builder.append(" Media não suportada, segue a lista: ");
